...
def index():
    ...
    prev_url = utl_for('index', page=posts.prev.num) \
...
def follow(username):
    ...
    if user == current_user:
        ...
        return refirect(url_for('user', username=username))
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check your email for the instrucrions to reset your password')
        return redirect(url_for('login'))
